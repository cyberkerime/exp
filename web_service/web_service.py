...
<head>
 ...
 <style>
  body{ font-family:Arial; text-aligan:center;padding: 50px; background: #eef2f3; }
  h1 { color:#333; }
  input { padding: 10px; font-size: 16px; }
  button { padding: 10px 15px; background: #4CAF50; color: white;border: none; broder-radius: 6px; cursor:pointer;}
